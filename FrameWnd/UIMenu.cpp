...
CMenuWnd::CMenuWnd(HWND hParent):m_hParent(hParent),
m_pOwner(NULL),
m_pLayout(),
m_xml(_T(""))
{
...
void CMenuElementUI::DoEvent(TEventUI& event)
{
	...
	if( event.Type == UIEVENT_BUTTONDOWN )
	{
        ...
        gmenusel= event.pSender->GetText();
		PostMessage(gparendHwnd,WM_MENUSELECTMSG,(WPARAM)(gmenusel.GetData()),0);
        return;
    }
